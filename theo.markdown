...
<img src="/img/theo/buttons-screen-atm.jpg">
*Figure 7: ATM menu compared to buttons and main menu on Bleepr screen*
...
If we were able to develop a more refined version 2 of Bleepr, I believe it would become a compelling system to be used in many restaurant and gastropub settings, and would be a very popular addition for both staff and customers. The hardware that I designed and constructed is a demonstration of what is possible for this project, but I believe if we had an increased budget, in terms of both time and money, we could create a much more refined and capable device for the Bleepr system.
